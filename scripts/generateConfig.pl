...
$host.sources.src1.bind = $host
$host.sources.src1.channels = ch1
$host.sinks.sink1.type = org.apache.flume.sink.hbase.HBaseSink
$host.sinks.sink1.channel = ch1
$host.sinks.sink1.table = dataTable
$host.sinks.sink1.columnFamily = cf
$host.sinks.sink1.column = tcol
$host.sinks.sink1.serializer = com.flexmet.hbaseSerializer.MetricEventHbaseSerializer
